...
if __name__ == "__main__":
    if len(sys.argv) != 4:
        print("Usage: exact_assembly_hap.py <assembly.fa> <config_file> <output_path>")
        sys.exit(1)
    ...
    chrs = config['chrs']
    starts = config['gap_starts']
    ends = config['gap_ends']

    # Extract sequences
    sequences = extract_sequences(reference_fa, chrs, starts, ends, output)
